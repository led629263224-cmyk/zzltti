...
const groundQuizData = [
    ...
    { type: "scale", q: "第二部分 Q22. 被连续击杀三次以上，我会明显感到烦躁并可能换玩法。", high: ["裸奔者", "CAS者"], low: ["轮椅者", "赤石者"] },
...
const airQuizData = [
    ...
    { type: "scale", q: "第二部分 Q17. 我开某架飞机，主要是因为它现实中存在过、或者电影里太帅了。", high: ["情怀坚守者"], low: ["轮椅享受者"] },
    ...
    { type: "choice", q: "第三部分 Q25. 你发现一架敌机比你高约2000米，正朝你俯冲下来，你会怎么做？", options: [ { text: "A. 尝试对头，拼火力", targets: ["火力爱好者"] }, { text: "B. 浅俯冲加速脱离，把他拖进低空消耗他的能量", targets: ["能量拥护者"] }, { text: "C. 看飞机性能，能跑就跑，跑不掉就下一局", targets: ["轮椅享受者", "情怀坚守者"] }, { text: "D. 找山或者云层躲避，等他放弃目标", targets: ["大粪舔食者", "古董品鉴者"] }, { text: "E. 我不在那个高度，我在地面附近活动", targets: ["陆战需求者", "没开空战者"] } ] },
...
const airResults = {
    ...
    "陆战需求者": { title: "💥 陆战需求者\nA10C", desc: "你本质上是个心系地面的无情舔地机器。你攀爬空战科技树的唯一目的，就是为了给陆战队列配置最强力的CAS（近距空中支援）。在天空中，你的眼睛总是死死盯着地面的履带，敌方战机只是你眼中的阻碍。", image: "images/cas_air.png" },
    "载具收藏者": { title: "🏆 载具收藏者\nR2Y2", desc: "你是战雷的仓鼠玩家。对你而言，每一场空战都只是为了点亮科技树上下一个图标的途径。不管是神车还是大粪，你都要亲手摸一摸。看到机库里满满当当的各个系别载具，就是你最大的成就感。", image: "images/collector.png" },
    "古董品鉴者": { title: "🕰️ 古董品鉴者\nBF109K", desc: "你是迷恋旧时代的古典飞行员。你对喷气时代的超视距和导弹互锁嗤之以鼻，唯独对二战的螺旋桨狗斗情有独钟。纯粹的机炮交锋、极致的机动拉扯，这才是你心中真正的“空战味道”。", image: "images/antique.png" },
    ...
    "没开空战者": { title: "🪖 没开空战者\nTIGER ", desc: "你是一个纯粹的陆地生物或海战舰长。天空对你来说只是被CAS折磨的来源，你对飞行器毫无兴趣。你的双脚坚实地踩在泥土上，比起在天上乱飞，你更愿意在地面上用履带丈量世界。", image: "images/no_air.png" }
};
